...
public class Chapter5SpringKafkaStreamsApplication {

	public static void main(String[] args) {
		SpringApplication.run(Chapter5SpringKafkaStreamsApplication.class, args);
	}

	// public static void main(String[] args) throws Exception {

	// 	ConfigurableApplicationContext context = SpringApplication.run(Chapter5SpringKafkaStreamsApplication.class, args);
